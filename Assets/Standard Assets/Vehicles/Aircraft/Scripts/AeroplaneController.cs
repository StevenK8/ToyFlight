...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        public float minCameraDistance = 25f;
        ...
        public void Shoot()
        {
            ...
            var rocket =
                Instantiate(Resources.Load("Rocket"),
        ...
        private void CalculateRollAndPitchAngles()
        {
            ...
            if (flatForward.sqrMagnitude > 0)
            {
                ...
                var localFlatForward =
                    transform.InverseTransformDirection(flatForward);
                PitchAngle =
                    Mathf.Atan2(localFlatForward.y, localFlatForward.z);

                // calculate current roll angle
                var flatRight = Vector3.Cross(Vector3.up, flatForward);
                var localFlatRight =
                    transform.InverseTransformDirection(flatRight);
        ...
        private void CalculateFov()
        {
            ...
            else if (cameraDistance > maxCameraDistance)
            {
                ...
                // Rescale the FOV based on the speed.
                cameraDistance = Mathf.Lerp(minCameraDistance, maxCameraDistance, ForwardSpeed / 180);
            }
            // push the camera back on the z axis
            // Mathf.Lerp(zPos, cameraDistance, transitionSpeed);
            myCamera.transform.localPosition = new Vector3(0, 5, -cameraDistance);
        ...
        private void CalculateDrag()
        {
            ...
            float extraDrag =
                m_Rigidbody.velocity.magnitude * m_DragIncreaseFactor;
        ...
        private void CaluclateAerodynamicEffect()
        {
            ...
            if (m_Rigidbody.velocity.magnitude > 0)
            {
                ...
                m_Rigidbody.rotation =
                    Quaternion
                        .Slerp(m_Rigidbody.rotation,
                        Quaternion
                            .LookRotation(m_Rigidbody.velocity, transform.up),
        ...
        private void CalculateLinearForces()
        {
            ...
            var liftDirection =
                Vector3.Cross(m_Rigidbody.velocity, transform.right).normalized;
        ...
        private void CalculateAltitude()
        {
            ...
            var ray =
                new Ray(transform.position - Vector3.up * 10, -Vector3.up);
            RaycastHit hit;
            Altitude =
