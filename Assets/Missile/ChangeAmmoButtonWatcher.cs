...
[System.Serializable]
public class ChangeAmmoButtonEvent : UnityEvent<bool> { }

public class ChangeAmmoButtonWatcher : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (var device in devicesWithTriggerButton)
        {
            ...
            tempState = device.TryGetFeatureValue(CommonUsages.primary2DAxisClick, out primaryButtonState) && primaryButtonState || tempState;
        }
